...
class lsm303_compass : private i2c2_device, public SingletonTemplate<lsm303_compass>
{
    public:
        ...
        uint8_t getPosition();	///< @returns Position
...
class lsm303_compass_accl : private i2c2_device, public SingletonTemplate<lsm303_compass_accl>
{
    public:
        bool init();   ///< Initializes the sensor
    ...
    private:
        /// Private constructor of this Singleton class
        lsm303_compass_accl() : i2c2_device(I2CAddr_Accelerometer)
        {
        }
        friend class SingletonTemplate<lsm303_compass_accl>;  ///< Friend class used for Singleton Template
